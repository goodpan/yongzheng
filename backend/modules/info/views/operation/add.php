...
<form class="layui-form" action="/info/operation/add" id="addForm">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="cred_name" lay-verify="required" autocomplete="off" placeholder="请输入证件名称" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="checkbox" name="is_hot" lay-skin="switch" lay-text="是|否" value="1" checked>
        </div>
    </div>
    ...
    <div class="layui-form-item layui-form-text">
        ...
        <div class="layui-input-block">
            <textarea class="layui-textarea layui-hide" name="condition" lay-verify="condition" id="editor_condition"></textarea>
        </div>
    </div>
    <div class="layui-form-item layui-form-text">
        <label class="layui-form-label">申请材料</label>
        <div class="layui-input-block">
            <textarea class="layui-textarea layui-hide" name="material" lay-verify="material" id="editor_material"></textarea>
        </div>
    </div>
    <div class="layui-form-item layui-form-text">
        <label class="layui-form-label">费用</label>
        <div class="layui-input-block">
            <textarea class="layui-textarea layui-hide" name="cost" lay-verify="cost" id="editor_cost"></textarea>
        </div>
    </div>
    <div class="layui-form-item layui-form-text">
        <label class="layui-form-label">申办地点</label>
        <div class="layui-input-block">
            <textarea class="layui-textarea layui-hide" name="locale" lay-verify="locale" id="editor_locale"></textarea>
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-input-block">
...
<script>
    ...
    layui.use(['form', 'layedit', 'laydate','upload'], function(){
        ...
        form.on('submit(add)', function(data){
            $.post('/info/operation/add',data.field,function (res) {
                if(res.code == 0){
                    layer.alert(res.msg);
