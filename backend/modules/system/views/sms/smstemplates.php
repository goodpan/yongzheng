...
<div class="layui-btn-group roles-table">
  <a class="layui-btn" href=""><i class="layui-icon">&#xe608;</i>添加短信模板</a>
...
<table class="layui-table" lay-data="{url:'/system/rbac/roledata', page:true, id:'roles'}" lay-filter="demo">
  <thead>
    <tr>
      ...
      <th lay-data="{field:'name', width:160}">应用场景</th>
      <th lay-data="{field:'description', width:200}">短信签名</th>
      <th lay-data="{field:'create_time', width:160}">短信模板</th>
      <th lay-data="{field:'create_time', width:300}">发送短信的内容</th>
      <th lay-data="{field:'create_time', width:120}">修改时间</th>
