...
(function(r) {
    var I, J, K, L, M, N, v, s = {},
        ...
        y = [function(b) {
            ...
            a.bind(c.CLICK, function(a, c, g, k, h) { j.apply(b.callback.onClick, [c, g, k, h]) });
            ...
            a.bind(c.ASYNC_SUCCESS, function(a, c, g, k) { j.apply(b.callback.onAsyncSuccess, [a, c, g, k]) });
            a.bind(c.ASYNC_ERROR, function(a, c, g, k, h, f) { j.apply(b.callback.onAsyncError, [a, c, g, k, h, f]) });
        ...
        A = [function(b) { var a = h.getCache(b);
            a || (a = {}, h.setCache(b, a));
            a.nodes = [];
            a.doms = [] }],
        ...
        u = [function(b) {
            ...
            else if (j.eqs(b.type, "dblclick") && (k = "dblclick", q = j.getMDom(c, a, [{ tagName: "a", attrName: "treeNode" + f.id.A }]))) d = j.getNodeMainDom(q).id, g = "switchNode";
            if (k.length > 0 && d.length == 0 && (q = j.getMDom(c, a, [{ tagName: "a", attrName: "treeNode" + f.id.A }]))) d = j.getNodeMainDom(q).id;
        ...
        C = [function(b) { var a = h.getRoot(b);
            a || (a = {}, h.setRoot(b, a));
        ...
        h = {
            ...
            addNodesData: function(b, a, c, d) { var e = b.data.key.children;
                a[e] ? c >= a[e].length && (c = -1) : (a[e] = [], c = -1); if (a[e].length > 0 && c === 0) a[e][0].isFirstNode = !1, i.setNodeLineIcos(b, a[e][0]);
            ...
            addSelectedNode: function(b, a) { var c = h.getRoot(b);
            ...
            getNodeIndex: function(b, a) { if (!a) return null; for (var c = b.data.key.children, d = a.parentTId ? a.getParentNode() : h.getRoot(b), e = 0, g = d[c].length - 1; e <= g; e++)
                    if (d[c][e] === a) return e;
                return -1 },
            ...
            getNodeCache: function(b, a) { if (!a) return null; var c = x[b.treeId].nodes[h.getNodeCacheId(a)]; return c ? c : null },
            ...
            getNodesByFilter: function(b, a, c, d, e) { if (!a) return d ? null : []; for (var g = b.data.key.children, k = d ? null : [], f = 0, i = a.length; f < i; f++) { if (j.apply(c, [a[f], e], !1)) { if (d) return a[f];
                        k.push(a[f]) } var q = h.getNodesByFilter(b, a[f][g], c, d, e); if (d && q) return q;
                    k = d ? q : k.concat(q) } return k },
            ...
            isSelectedNode: function(b, a) { for (var c = h.getRoot(b), d = 0, e = c.curSelectedList.length; d < e; d++)
            ...
            transformTozTreeFormat: function(b, a) { var c, d, e = b.data.simpleData.idKey,
                    g = b.data.simpleData.pIdKey,
                    k = b.data.key.children; if (!e || e == "" || !a) return []; if (j.isArray(a)) { var f = [],
                        h = {}; for (c = 0, d = a.length; c < d; c++) h[a[c][e]] = a[c]; for (c = 0, d = a.length; c < d; c++) h[a[c][g]] && a[c][e] != a[c][g] ? (h[a[c][g]][k] || (h[a[c][g]][k] = []), h[a[c][g]][k].push(a[c])) : f.push(a[c]); return f } else return [a] }
        },
        m = {
            ...
            doProxy: function(b) { for (var a = [], c = 0, d = u.length; c < d; c++) { var e = u[c].apply(this, arguments);
                    a.push(e); if (e.stop) break } return a },
            proxy: function(b) {
    ...
    I = function(b, a) { var c = h.getSetting(b.data.treeId); if (a.open) { if (j.apply(c.callback.beforeCollapse, [c.treeId, a], !0) == !1) return !0 } else if (j.apply(c.callback.beforeExpand, [c.treeId, a], !0) == !1) return !0;
        h.getRoot(c).expandTriggerFlag = !0;
        i.switchNode(c, a); return !0 };
    J = function(b, a) {
    ...
    var j = {
            apply: function(b, a, c) { return typeof b == "function" ? b.apply(P, a ? a : []) : c },
            canAsync: function(b, a) { var c = b.data.key.children; return b.async.enable && a && a.isParent && !(a.zAsync || a[c] && a[c].length > 0) },
            clone: function(b) { if (b === null) return null; var a = j.isArray(b) ? [] : {},
                    c; for (c in b) a[c] = b[c] instanceof Date ? new Date(b[c].getTime()) : typeof b[c] === "object" ? j.clone(b[c]) : b[c]; return a },
        ...
        i = {
            ...
            asyncNode: function(b, a, c, d) {
                ...
                if (a) a.isAjaxing = !0, l(a, f.id.ICON, b).attr({ style: "", "class": f.className.BUTTON + " " + f.className.ICO_LOADING });
                var k = {};
                for (e = 0, g = b.async.autoParam.length; a && e < g; e++) { var p = b.async.autoParam[e].split("="),
                        n = p;
                ...
                r.ajax({
                    ...
                    success: function(g) { if (m == h.getRoot(b)._ver) { var e = []; try { e = !g || g.length == 0 ? [] : typeof g == "string" ? eval("(" + g + ")") : g } catch (k) { e = g } if (a) a.isAjaxing = null, a.zAsync = !0;
            ...
            cancelPreSelectedNode: function(b, a, c) { var d = h.getRoot(b).curSelectedList,
                    e, g; for (e = d.length - 1; e >= 0; e--)
                    if (g = d[e], a === g || !a && (!c || c !== g))
                        if (l(g, f.id.A, b).removeClass(f.node.CURSELECTED), a) { h.removeSelectedNode(b, a); break } else d.splice(e, 1), b.treeObj.trigger(f.event.UNSELECTED, [b.treeId, g]) },
            ...
            createNodes: function(b, a, c, d, e) { if (c && c.length != 0) { var g = h.getRoot(b),
                        k = b.data.key.children,
                        k = !d || d.open || !!l(d[k][0], b).get(0);
                    g.createdNodes = []; var a = i.appendNodes(b, a, c, d, e, !0, k),
                        j, n;
            ...
            expandCollapseNode: function(b, a, c, d, e) {
                var g = h.getRoot(b),
                    ...
                    p;
                if (a) {
                    if (g.expandTriggerFlag) p = e, e = function() { p && p();
                        a.open ? b.treeObj.trigger(f.event.EXPAND, [b.treeId, a]) : b.treeObj.trigger(f.event.COLLAPSE, [b.treeId, a]) }, g.expandTriggerFlag = !1;
            ...
            isSelectedNode: function(b, a) { if (!a) return !1; var c = h.getRoot(b).curSelectedList,
            ...
            makeNodeIcoClass: function(b, a) { var c = ["ico"];
            ...
            removeChildNodes: function(b, a) { if (a) { var c = b.data.key.children,
                        d = a[c]; if (d) { for (var e = 0, g = d.length; e < g; e++) h.removeNodeCache(b, d[e]);
            ...
            scrollIntoView: function(b) {
                if (b) {
                    if (!Element.prototype.scrollIntoViewIfNeeded) Element.prototype.scrollIntoViewIfNeeded =
                        function(a) {
                            function b(a, d, e, f) { return { left: a, top: d, width: e, height: f, right: a + e, bottom: d + f, translate: function(g, k) { return b(g + a, k + d, e, f) }, relativeFromTo: function(k, h) { var i = a,
                                            j = d,
                                            k = k.offsetParent,
                                            h = h.offsetParent; if (k === h) return g; for (; k; k = k.offsetParent) i += k.offsetLeft + k.clientLeft, j += k.offsetTop + k.clientTop; for (; h; h = h.offsetParent) i -= h.offsetLeft + h.clientLeft, j -= h.offsetTop + h.clientTop; return b(i, j, e, f) } } }
            ...
            replaceSwitchClass: function(b,
                a, c) { if (a) { var d = a.attr("class"); if (d != void 0) { d = d.split("_"); switch (c) {
                            case f.line.ROOT:
                            case f.line.ROOTS:
                            case f.line.CENTER:
                            case f.line.BOTTOM:
            ...
            setNodeFontCss: function(b, a) { var c = l(a, f.id.A, b),
            ...
            setNodeName: function(b, a) { var c = h.getNodeTitle(b, a),
                    d = l(a, f.id.SPAN, b);
                d.empty();
            ...
            setNodeUrl: function(b, a) { var c = l(a, f.id.A, b),
                    d = i.makeNodeUrl(b, a);
        ...
        init: function(b, a, c) {
            ...
            var e = {
                ...
                addNodes: function(a, b, c, e) {
                    function f() { i.addNodes(d, a, b, l, e == !0) }
                    a || (a = null);
                ...
                reAsyncChildNodes: function(a, b, c, e) {
                    if (this.setting.async.enable) {
                        var j = !a;
                        j && (a = h.getRoot(d));
                        if (b == "refresh") { for (var b = this.setting.data.key.children, m = 0, r = a[b] ? a[b].length : 0; m < r; m++) h.removeNodeCache(d, a[b][m]);
                ...
                refresh: function() { this.setting.treeObj.empty(); var a = h.getRoot(d),
                ...
                selectNode: function(a, b, c) {
                    function e() { if (!c) { var b = l(a, d).get(0);
                            i.scrollIntoView(b) } } if (a && j.uCanDo(d)) { b = d.view.selectedMulti && b; if (a.parentTId) i.expandCollapseParentNode(d, a.getParentNode(), !0, !1, e);
                ...
                updateNode: function(a) { a && l(a, d).get(0) && j.uCanDo(d) && (i.setNodeName(d, a), i.setNodeTarget(d, a), i.setNodeUrl(d, a), i.setNodeLineIcos(d, a), i.setNodeFontCss(d, a)) }
            };
            b.treeTools = e;
            h.setZTreeTools(d, e);
