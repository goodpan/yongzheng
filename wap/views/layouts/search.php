		...
		<div class="top_colum">
	        ...
	        <div class="select_area">
				<div class="select_item flex">
					<a href='/info/site/search' <?=$action=='search'?'class="active"':''?>>搜证件</a>
					<a href='/info/site/searchcomp' <?=$action=='searchcomp'?'class="active"':''?>>搜企业</a>
					<a href='/info/site/searchperson' <?=$action=='searchperson'?'class="active"':''?>>搜个人</a>
				</div>
				...
				<?}else{?>
	            <div class="area_list_other flex">
	                <span :class="{ on: condition=== 'default' }" @click="doDefaultSort">默认排序</span> 
			...
			<div id="mescroll" class="mescroll">
	   			<div class="mescroll-bounce" v-if="!isEmpty">
					...
					<ul id="s-def" class="data-list">
                       ...
                       <?}else if($action=='searchcomp'){?>
						<ul id="s-def" class="data-list">
                        <li v-for="item in dataList">
                            <a href="" class="flex">
                                <div class="list_img">
                                    <img :src="item.sCompLogo" alt="">
                                </div>
                                <div class="list_content flexOne">
                                    <h2 class="singleEllipsis" v-text="item.sName"></h2>
                                    <div class="good_at">
                                        <span class="field">擅长领域</span>
                                        <span v-text="item.sTypeName"></span>
                                    </div>
                                    <div class="company_position">
                                        <i class="icon">&#xe754;</i>
                                        <span v-text="item.sAddress">福建 厦门</span>
                       ...
                       <?}else if($action=='searchperson'){?>
						<ul id="s-def" class="person_list">
                        <li v-for="item in dataList">
							<a href="">
								<div class="personnel_info flex">
									<div class="company_pic">
										<img :src="item.sCompLogo">
									</div>
									<div class="company_info">
										<h3 class="singleEllipsis" v-text="item.sNickName"></h3>
										<p v-text="item.sFunctionName"></p>
										<div class="company_position">
											<i class="icon">&#xe754;</i>
											<span v-text="item.sAddress">福建 厦门</span>
										</div>
							...
							<div class="personnel_skill">
								<div class="skill_item flex">
									...
									<p v-text="item.sTypeName">商城、社交、小程序、管理软件、物联网、人工智能</p>
								</div>
								<div class="skill_item flex">
									<span class="good_at">技能</span>
									<p v-text="item.sSkillName">PHP、Javascript</p>
								</div>
							</div>
						</li>
						</ul>
