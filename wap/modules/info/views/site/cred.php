    ...
    <div class="swiper-container">
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <img src="<?php echo $credentialDetail->cover; ?>" alt="">
            </div>
        </div>
...
<div class="describe">
    <h1 class="multiEllipsis"><?php echo $credentialDetail->cred_name; ?></h1>
    <p class="multiEllipsis"><?php echo $credentialDetail->descr; ?></p>
    <p class="local"><i class="icon">&#xe754;</i><span class="text"><?php echo $credentialDetail->locale; ?></span></p>
</div>
<div class="commodity_details">
    ...
    <div class="details_content">
        <?php echo $credentialDetail->descr; ?>
    </div>
    <!--售后说明-->
    <div class="details_content" style="display: none;">
        <div class="service_con">
            <p><span
                    style="color: rgb(34, 34, 34); font-family: Consolas, &quot;Lucida Console&quot;, &quot;Courier New&quot;, monospace; font-size: 12px; white-space: pre-wrap; background-color: rgb(255, 255, 255);"><?php echo $credentialDetail->material; ?></span>
            </p>
            <!--                <p><span style="color: rgb(34, 34, 34); font-family: Consolas, &quot;Lucida Console&quot;, &quot;Courier New&quot;, monospace; font-size: 12px; white-space: pre-wrap; background-color: rgb(255, 255, 255);"><img src="http://backend.shop.myerm.cn/js/global/plugins/ueditor/php/../../../../../userfile/upload/20171115/15107331394054.jpg" title="截图69.jpg"/></span></p>         -->
        </div>
    </div>
</div>
