...
才，解决你的问题。
    ...
    <form action="" class="req-form" id="req-form">
        ...
        <div class="form-item-wrap">
            ...
            <div class="item-elm">
                <textarea name="sContent" id="" cols="30" rows="10" class="desc" placeholder="如：我要做分销商城，可以下单、上传商品、三级分销。接单的企业要有做过这方面的客户"></textarea>
            </div>
        </div>
        <div class="form-item">
        ...
        <div class="form-item">
            <label for="dDeliverDate" class="item-label">要求交付时间</label>
            <div class="item-elm">
